...
default_data_ref <- function(){
  ...
  data_ref = list(
      'summaryData'=list('geometry_name'='Country'),
      'rtData'=list('geometry_name'='country'),
      'casesInfectionData'=list('geometry_name'='country'),
      'casesReportData'=list('geometry_name'='country'),
