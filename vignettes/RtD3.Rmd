...
Rt data is passed to the visualization function in a JSON-like list of lists to allow for visualization of different data training data sources. Rt data should be prepared in the format `{'Source':{'rtData':x, 'casesInfectionData':x, 'casesReportData':x, 'obsCasesData':x}, ...}`
...
All required datasets are then passed to the visualization function. Note: missing datasets in `rtData` should be `NULL`, not absent.
