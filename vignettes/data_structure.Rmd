...
`"country","date","type","median","lower_90","upper_90","lower_50","upper_50", "lower_20", "upper_20"` 

All entries in the rtData list must contain the values (either `data.frame` values or `NULL` values):  
