---
title: "Subnational Visualisations"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEngine{knitr::knitr}
  %\VignetteIndexEntry{Subnational Visualisations}
...
RtD3 supports visualisations for subnational estimates using the same interface. Data must have the same structure and columns as global data. 

## India

Plotting subnational estimates requires that column names are identical to the columns required from gloabl estimates. 
